...
### Floating Wallet (Default)

By default, the wallet appears in the bottom right corner:
...
Uses border instead of shadow, great for minimal designs:
...
### Example 1: Basic Floating Wallet
...
### Example 2: Custom Sidebar Placement
...
### Example 3: With RemoteStorage Sync
