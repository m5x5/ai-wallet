...
export class HeroSection {
  ...
  render() {
    return (
      <Host>
        <div class="grid min-h-1/2 overflow-hidden pt-hero bg-gradient-to-br from-green-500 to-indigo-500 place-items-center">
          <div class="flex flex-col justify-between w-full max-w-6xl gap-4 p-4 mt-10 mb-48 item text-slate-100">
            <h1 class="flex flex-col gap-2 py-4 mb-2 font-extrabold text-center">
              <span class="text-4xl">AI Wallet</span>
            </h1>
